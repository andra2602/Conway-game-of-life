...
main:
	...
	pushl $formatScanf
	pushl if
	call fscanf		#citesc m = numarul de linii
	addl $12, %esp
	...
	pushl $formatScanf
	pushl if
	call fscanf		#citesc n = numarul de coloane
	addl $12, %esp
	
	pushl $p
	pushl $formatScanf
	pushl if
	call fscanf		#citesc p = numarul de celule vii
	addl $12, %esp
...
et_for_p_celule_vii:
	...
	pushl $formatScanf
	pushl if
	call fscanf		#citesc left = coordonata pentru linie a unei celule vii
	addl $12, %esp
	
	pushl $right
	pushl $formatScanf
	pushl if
	call fscanf		#citesc right = coordonata pentru coloana a unei celule vii
	addl $12, %esp
